...
export const PASSENGER_SELECTORS = {
    ...
    PASSENGER_INFANT_ADD_BTN_TEXT: '+ Add Infant Without Berth',
    PASSENGER_INFANT_COMPONENT: 'app-infant',
    PASSENGER_INFANT_NAME_INPUT: 'input[formcontrolname="name"]',
    PASSENGER_INFANT_AGE_SELECT: 'select[formcontrolname="age"]',
    PASSENGER_INFANT_GENDER_SELECT: 'select[formcontrolname="gender"]',
